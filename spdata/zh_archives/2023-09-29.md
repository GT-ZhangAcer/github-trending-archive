...
8. [](https://github.comundefined "Kscan是一款纯go开发的全方位扫描器，具备端口扫描、协议检测、指纹识别，暴力破解等功能。支持协议1200+，协议指纹10000+，应用指纹20000+，暴力破解协议10余种。") [Go]
9. [](https://github.comundefined "《明日方舟》小助手，全日常一键长草！| A one-click tool for the daily tasks of Arknights, supporting all clients.") [C++]
10. [](https://github.comundefined "WebRTC P2P online web media streaming tool (for files, video, screen, live streaming, text) with management and statistical monitoring capabilities.") [JavaScript]
...
13. [](https://github.comundefined "Hello World！非钟国优化线路使用不佳？不想中转？hysteria一键搞定。") [Shell]
14. [](https://github.comundefined "A proxy tool to bypass GFW.") [Python]
15. [](https://github.comundefined "数据备份 DataBackup for Android") [Kotlin]
16. [](https://github.comundefined "FongMi影视、tvbox、猫影视配置文件，如果喜欢，请Fork自用。使用前请仔细阅读仓库说明，一旦使用将被视为你已了解。") [JavaScript]
...
21. [](https://github.comundefined "wow game server everwar开源魔兽世界 https://everwar.cn") [C++]
...
25. [](https://github.comundefined "MiniOB is one mini database, helping developers to learn how database works.") [C++]
